...
- **Entwicklungsmaterial** — Implementierungsdoku, eigener Fahrplan, Testsuite, Diagnosewerkzeuge, Belegmaterial. Es gehört ebenfalls nicht an den Zielort. Diesen Fall gibt es bisher einmal, bei `chat-export`; die Begründung steht in der `README.md` von `skills/`.
