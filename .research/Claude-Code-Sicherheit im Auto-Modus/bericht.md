...
2. **Verfahren (Skill).** Der wiederkehrende Ablauf — erst lesend die Lage prüfen, dann je Ebene um Zugriff bitten statt Befehl für Befehl — gehört in einen Skill. Skills sind der richtige Ort für „manchmal relevantes" Vorgehen.
