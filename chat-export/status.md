...
- **27b/27c** `diff` nennt die UUIDs bereits, nichts zu ergänzen. Und der echte Lauf: eine zweite, unabhängige Claude-Code-Sitzung führte den Skill über zwei Team-Projekte, mit kaum Zutun des Nutzers — vier Chats korrekt exportiert, Format und Ablage stimmen mit `SKILL.md` überein (Testlauf, Abschnitt „27c"). Nur die README des Skills bleibt an Punkt 27 offen.
