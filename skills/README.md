...
| [`git-branch-model/`](git-branch-model/README.md)<br>✅☑ | **Ein Git-Projekt mit Entwicklungs-, Release- und Verwaltungszweig führen** — Themenzweige per Merge, Release-Übernahme als Merge oder Datei für Datei, und ein orphaner Verwaltungszweig für Dateien, die auf jedem Zweig gleich sein müssen: verteilt durch Überlagern statt Merge, mit einem Abgleich, der Veraltetes überschreibt und Neues meldet. |
| [`git-workbench/`](git-workbench/README.md)<br>✅☑ | **Wie eine Claude-Sitzung committet** — direkt auf dem aktuellen Zweig, auf einer Werkbank mit Absicherungs-Commits und Squash-Abschluss, oder isoliert im eigenen Git-Worktree für mehrere Sitzungen gleichzeitig; dazu eine Push-Regel gegen gestrandete Zweige beim Rechnerwechsel. |
...
| [`🚧_software-design-doc/`](🚧_software-design-doc/doc/1_overview.md)            | **Dokumentationsstandard für die Planung vor der Kodierung und die laufende Mitschrift des Implementierten** — was umgesetzt wird, welche Festlegungen getroffen wurden und warum so und nicht anders. Softwareprojektbegleitende Dokumentation als Basis für Coding, Fehlersuche und späterer Schluss- und Anwenderdokumentation. **Im Neuaufbau:** Härteregeln, Register mit Marken und Dokumentrollen; der Link führt zur Implementierungsdoku des Umbaus, der Vorläufer ist dort in Anhang A archiviert. |
...
| [`system-access/`](system-access/README.md)<br>✅☑ | **Regeln für das Arbeiten auf einem laufenden System** — welches System überhaupt gemeint ist, welcher Bereich darin freigegeben ist, was vor einem Eingriff lesend zu erkunden ist und wie der Rückweg aussieht; dazu der Schutz der eigenen Verbindung und der Arbeit anderer Menschen am System. Für Wartung, Aktualisierung und Schwachstellensuche — nicht für die gewöhnliche Arbeit im Projektordner. |
