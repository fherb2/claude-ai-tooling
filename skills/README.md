...
| [`🚧_web-code-editing/`](🚧_web-code-editing/README.md)              | **Umgang mit Code-Artefakten im Web-Frontend**: wann Code als Artefakt entsteht und wann als Änderungsanweisung im Chat, und in welcher Form Änderungen an bereits übernommenem Code mitgeteilt werden.                                                                                                                             |
