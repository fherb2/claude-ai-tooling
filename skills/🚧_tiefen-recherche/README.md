...
- **Ergebnisübergabe:** zuerst vollständig im Chat; in claude.ai entsteht zusätzlich automatisch ein Artefakt, in Claude Code wird der Speicherort erfragt — außer der Auftrag nennt selbst schon eine Zieldatei.
