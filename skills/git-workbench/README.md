...
**Gemessen (16. September 2026, Verfahren nach Kapitel 4.2 der Vorgaben, 34 Läufe mit Sonnet, Opus und Fable):** Der Trigger feuert bei allen drei Modellen auf einen schlichten Commit-Auftrag, mit und ohne Konfigurationsdatei; die Negativkontrolle (eine Git-Frage ohne Schreibvorhaben) bleibt still. Der Skill ist damit am Anker „erstes schreibendes Git-Kommando" verlässlich — verlässlicher als sein Nachbar am selben Anker, dessen Description den Commit-Fall nicht trifft (siehe dessen README).
