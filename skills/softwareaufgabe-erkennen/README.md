...
**Teilweise überholt.** `common-code-generation-de` trägt inzwischen einen Teil dessen, was hier als Idee steht: Er wird ausgelöst, wenn Code entsteht, auch ohne dass die Anfrage von Code spricht.

**Offen:**

- Entscheiden, ob daraus ein eigenständiger Skill wird, ob er die Vorstufe von `software-dev-doc-fh` ist — oder ob er sich mit `common-code-generation-de` erledigt hat. Erst danach lohnt Arbeit am Inhalt.
