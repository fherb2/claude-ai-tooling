...
## Durchsicht vom 2026-09-25

Eine Durchsicht der gesamten Doku gegen die bereits getroffenen Entscheidungen ergab fünfzehn Befunde: Folgen von Entscheidungen, die noch nirgends im Text stehen; Widersprüche zwischen zwei Stellen; Lücken im Aufbau. Sie stehen seitdem nicht in einem Review-Anhang, sondern an der Stelle, an der die Entscheidung fällt — vorzugsweise in Kapitel 1, sonst in Kapitel 2, und nur bei Detailfragen der begonnenen Umsetzung in Kapitel 3 (Festlegung des Entwicklers vom 2026-09-25, begründet damit, dass das Vorhaben noch in der Konzipierung steht und ein Review-Anhang erst später sein Verfahren ist). Die Übersicht mit Nummern und Orten steht in `work-plan.md`; abgearbeitet werden sie einzeln.
