...
| [`🚧_tiefen-recherche/`](🚧_tiefen-recherche/README.md) (in German)<br>🚧 | **Thorough source and literature research that does not give up too early** — systematic variation of search terms, channels and levels, mandatory verification of search summaries, open search paths instead of "nothing found". First draft written, untested. |
